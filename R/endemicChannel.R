...
#' @param incidence_object An incidence or incidenceRate object with the current observations
#' @param incidence_historic An incidence or incidenceRate object with the historic observations
...
#' @export
endemicChannel <- function(incidence_object, incidence_historic, method = "geometric", period_window = 0, CI = 0.95, plot = FALSE) {
  
  
  
  
  get_mode(year(incidence_object$dates))
