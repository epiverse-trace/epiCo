...
The broader definition and methodology for the endemic channel were provided by [Bormant (1999)](https://iris.paho.org/handle/10665.2/8562).
...
Finally, the `endemic_channel` function can perform a Poisson test (unusual behavior method) on the historical data if it is requested by the user after taking into the account the pertinence of the test, since it is mostly used for scenarios or diseases with very low incidence records. This method uses the arithmetic mean as CTM.
...
### Tips (section in development)

### Warnings and disclosures (section in development)

### Exporting the endemic channel plot (section in development)
