...
cali_pyramid_2016 <- population_pyramid(cali_code, year)
# Population pyramid (dataframe) for the city of Cali in the year 2016
...
ibague_pyramid_2016 <- population_pyramid(ibague_code, year,
  range = age_range,
  total = FALSE, plot = TRUE
)
#```
...
data_event <- sivirep::import_data_event(
 year = 2019,
 nombre_event = "dengue"
)
data_event_clean <- sivirep::limpiar_data_sivigila(data_event = data_event,
year = 2019)
#```
...
#   dates = data_event_clean$fec_not,
#   groups = data_event_clean$cod_mun_o,
#   interval = "1 epiweek"
# )
...
age_risk_data <- age_risk(age = data_event_cali$edad,
population_pyramid = cali_pyramid_2016, gender = TRUE, plot = TRUE)
#```
